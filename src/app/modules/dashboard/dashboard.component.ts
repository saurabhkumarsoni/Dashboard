...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.piChartData = this.dashboardService.pieCharts();
    this.bubbleChartData = this.dashboardService.bubbleCharts();
    this.columnData = this.dashboardService.getColumnData();
